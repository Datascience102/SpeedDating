...
Those qualities reflect following questions from the survey:
...
"attr2_1", "sinc2_1", etc. | What do you think the opposite sex looks for in a date? Waves 6-9: Please rate the importance of the following attributes on a scale of 0-100 (0=not at all important, 100=extremely important) (attractive, sincere, intelligent, fun, ambitions, shared interests/hobbies)
...
## printing the result in a clean-slate table
iprint.df(round(cluster_profile_ratios, 1))
```
...
for (i in idxs) {
  ...
  write.csv2(output, file = paste("data/SpeedDating_segmented_", i, ".csv", sep = ""))
}
```
<hr>\clearpage
