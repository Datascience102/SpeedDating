...
ProjectData <- data.matrix(ProjectData[,independent_variables]) 

# remove rows with empty cells
ProjectData_clean <- ProjectData[rowSums(is.na(ProjectData)) == 0,]

ProjectData_INITIAL <- ProjectData_clean

ProjectData <- ProjectData_clean
