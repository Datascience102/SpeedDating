...
# factor_attributes_used = c("attr1_1",	"sinc1_1",	"intel1_1", "fun1_1","amb1_1", "shar1_1", "attr1_1", "sinc3_1",	"intel3_1", "fun3_1","amb3_1")
...
a <- c(1,11,21,31,41,51,61,71,81,91,101,111,121,131,141,151,161,171,181,191,201)
x <- ProjectData_with_kmeans_membership[a,]

iprint.df(round(head(x, max_data_report), 2))
```
