...
datafile_name = "data/SpeedDatingData_clean_mw.csv"
...
factor_attributes_used = c("goal", "attr1_1",	"sinc1_1",	"intel1_1", "fun1_1","amb1_1", "shar1_1", "attr1_1", "sinc3_1",	"intel3_1", "fun3_1","amb3_1")
...
# Please use numbers, not column names! e.g. c(1:5, 7, 8) uses columns 1,2,3,4,5,7,8
independent_variables= c(1:9,11:60) # use 54-80 for boats
